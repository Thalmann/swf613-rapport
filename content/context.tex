...
The Launcher contains all applications developed by GIRAF.
\mikael{Jeg synes der mangler noget forklaring af Launcher som homescreen og at man kan bruge det som eneste homescreen da de andre apps kan inkluderes}
\mikael{Der kunne nok også være et afsnit om apps'ene i launcher, med nogle eksempler på fx. pictooplæser, skema, oasis-app og pictotegner}
...
Cars is a sub-application of the GIRAF-application and therefore needed to follow certain project-standards.
For Cars there were two overall standards; shared data and shared GUI.

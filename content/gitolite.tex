...
As most users had previously only been exposed to the SVN content management system, there were some confusion as to Gits additional \textit{staging} and \textit{pushing} steps in the commit process.

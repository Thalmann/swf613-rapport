...
An example of low cohesion in the cars project is the \lstinline!Car! class.\stefan{reference?} 
...
When trying to change the existing implementation of control of the car by pitch to control by volume, it turned out to be very hard.\stefan{possibly a reference to FFT analysis chapter}
